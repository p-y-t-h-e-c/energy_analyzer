...
def add_electricity_rates_data_to_db(Get_Octopus_Electricity_Rates_Data) -> None:
...
@asset
def add_gas_rates_data_to_db(Get_Octopus_Gas_Rates_Data) -> None:
...
@asset(deps=[add_gas_rates_data_to_db])
...
@asset
def add_electricity_consumption_data_to_db(get_electricity_consumption_data) -> None:
...
@asset
def add_gas_consumption_data_to_db(get_gas_consumption_data: pd.DataFrame) -> None:
    ...
    """
    DB_CONNECTOR.add_data_to_db(
        get_gas_consumption_data, table_name=GasConsumptionTable.__tablename__
    )
...
def add_electricity_weekly_consumption_data_to_db(
    get_electricity_weekly_consumption_data: pd.DataFrame,
) -> None:
    ...
    """
    DB_CONNECTOR.add_data_to_db(
        get_electricity_weekly_consumption_data,
...
def add_gas_weekly_consumption_data_to_db(
    get_gas_weekly_consumption_data: pd.DataFrame,
) -> None:
    ...
    """
    DB_CONNECTOR.add_data_to_db(
        get_gas_weekly_consumption_data,
